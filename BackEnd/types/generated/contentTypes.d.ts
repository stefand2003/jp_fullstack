...
export interface ApiHomeSectorHomeSector extends Schema.SingleType {
  collectionName: 'home_sectors';
  info: {
    singularName: 'home-sector';
    pluralName: 'home-sectors';
    displayName: 'HomeSector';
  };
  options: {
    draftAndPublish: true;
  };
